 ...
 * @var iterable<\App\Model\Entity\TimeTracking> $timeTracking
 */
?>
<div class="timeTracking index content">
    <?= $this->Html->link(__('New Time Tracking'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Time Tracking') ?></h3>
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php foreach ($timeTracking as $timeTracking): ?>
                <tr>
